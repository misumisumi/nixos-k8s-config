...
// builtins.mapAttrs (
  ...
  in
  {
    imports =
      ...
      ++ lib.optional (builtins.pathExists ./node/nix/${extracted_name}/colmena.nix) ./node/nix/${extracted_name}/colmena.nix
      ++ lib.optional (builtins.pathExists ./devnode/nix/${name}/colmena.nix) ./devnode/nix/${name}/colmena.nix;
