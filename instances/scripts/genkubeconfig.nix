      ...
      clusters = [
        {
          name = variant;
          cluster = {
            certificate-authority = "$PROJ_ROOT/instances/secrets/${variant}/pki/RootCA/ca.pem";
      ...
      users = [
        {
          name = "user";
          user = {
            client-certificate = "$PROJ_ROOT/instances/secrets/${variant}/pki/kubernetes/admin-chain.pem";
            client-key = "$PROJ_ROOT/instances/secrets/${variant}/pki/kubernetes/admin-key.pem";
          };
        }
      ];
    }
